...
export default function TaskDetailsHeader({ backHref, backLabel, canEdit, onEditClick }: TaskDetailsHeaderProps) {
  return (
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        {canEdit ? (
          <Button variant="outline" className="rounded-xl border-gray-200 bg-white" onClick={onEditClick}>
            Edit Task
          </Button>
        ) : null}
