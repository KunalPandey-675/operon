          ...
          <Card className="border-none shadow-2xl shadow-blue-50/50 bg-white p-2">
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="pt-8 pb-8 flex justify-end gap-3 px-8 border-t bg-gray-50/30 rounded-b-2xl">
                <Link href="/dashboard">
                  <Button variant="ghost" className="h-12 px-6 font-semibold">Cancel</Button>
                </Link>
                <Button type="submit" className="h-12 px-8 bg-blue-600 hover:bg-blue-700 font-bold shadow-lg shadow-blue-200 transition-all hover:scale-105 active:scale-95 group">
